    ...
    <div className='bg-crew-bg pt-[171px] pb-[225px] bg-no-repeat bg-cover max-lg:py-20 max-md:py-16 max-sm:py-10'>
      <div className='px-4'>
        ...
        <div className='flex items-center justify-center gap-[131px] pt-[85px] max-lg:pt-20 max-md:pt-12 max-sm:pt-8 max-[1440px]:gap-10 max-md:gap-8 max-sm:gap-5 max-lg:flex-wrap'>
          <div>
            <img src={scouts} alt="scouts" className=' h-[254px] max-[1440px]:h-48 rounded-[20px] max-lg:w-48 object-cover' />
          ...
          <div>
            <img src={heavies} alt="heavies" className=' h-[254px] max-[1440px]:h-48 rounded-[20px] max-lg:w-48 object-cover' />
          ...
          <div>
            <img src={legends} alt="legends" className=' h-[254px] max-[1440px]:h-48 rounded-[20px] max-lg:w-48 object-cover' />
          ...
          <div>
            <img src={elementals} alt="elementals" className=' h-[254px] max-[1440px]:h-48 rounded-[20px] max-lg:w-48 object-cover' />
